...
export const ClubStudentsModal: React.FC<ClubStudentsModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-3xl max-w-xl w-full shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-zinc-200/80 animate-fadeIn text-zinc-900">
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-zinc-900">
              ...
              {filteredToDirectAdd.length === 0 ? (
                ...
                filteredToDirectAdd.map((st) => (
                  <div
                    ...
                    className="flex items-center justify-between p-2.5 text-xs hover:bg-indigo-50/20 transition"
                  >
          ...
          <div className="space-y-3">
            ...
            {clubStudentsLoading ? (
              ...
              <p className="text-xs text-zinc-400 italic text-center py-6 bg-zinc-50 border border-dashed border-zinc-200 rounded-2xl">
