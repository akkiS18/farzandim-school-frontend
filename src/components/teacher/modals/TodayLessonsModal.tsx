                ...
                >
                  ...
                  <div className="pl-2 space-y-1">
                    <div className="flex items-center gap-2">
                      <h5 className="text-sm font-extrabold text-[#16193E] group-hover:text-indigo-600 transition">
                        {lesson.subject_name}
                      </h5>
            ...
            <div className="pt-4 border-t border-zinc-100 space-y-3">
              ...
              <div className="space-y-2">
                {clubs.map((club, idx) => (
                  <div
                    key={club.id || idx}
                    className="bg-purple-50/60 border border-purple-100 rounded-2xl p-3.5 flex items-center justify-between"
                  >
                    <div>
                    ...
                    <span className="text-[10px] font-bold bg-purple-200/70 text-purple-900 px-2.5 py-1 rounded-xl">
                      To'garak
                    </span>
                  </div>
                ))}
